"""Textual TUI interface for Aider.

This package provides an experimental TUI (Terminal User Interface) for aider
using the Textual framework. Launch with: aider-ce --tui
"""
